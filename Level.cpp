...
Level::Level(int stage, PlaySideBar* sideBar, Player* player) {
	...
	mStageLabel->Position(GraphicsManager::SCREEN_WIDTH * 0.35f,
		GraphicsManager::SCREEN_HEIGHT * 0.5f);
	mStageNumber = new Scoreboard({ 75, 75, 200 });
	mStageNumber->Score(mStage);
	mStageNumber->Parent(this);
	mStageNumber->Position(GraphicsManager::SCREEN_WIDTH * 0.5f,
		GraphicsManager::SCREEN_HEIGHT * 0.5f);
	...
	mReadyLabel->Position(GraphicsManager::SCREEN_WIDTH * 0.4f,
		GraphicsManager::SCREEN_HEIGHT * 0.5f);
	...
	mGameOverLabel->Position(GraphicsManager::SCREEN_WIDTH * 0.4f, GraphicsManager::SCREEN_HEIGHT * 0.5f);
	mGameOverDelay = 6.0f;
	mGameOverTimer = 0.0f;
	...
	mFormation->Position(GraphicsManager::SCREEN_WIDTH * 0.4f, 150.0f);
